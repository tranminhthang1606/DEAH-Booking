...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Manage Wards</h1>
                <a href="{{ route('admin.wards.create') }}" class="btn btn-primary mb-3">Add New Ward</a>
                <div class="card">
                                ...
                                @foreach ($wards as $ward)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.wards.destroy', $ward->id) }}" method="POST" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
