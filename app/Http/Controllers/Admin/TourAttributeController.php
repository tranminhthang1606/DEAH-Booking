...
class TourAttributeController extends Controller
{
    ...
    public function update(Request $request, TourAttribute $tourAttribute)
    {
        ...
        return redirect()->route('admin.tourAttributes.index')->with('success','Tour Attribute updated successfully');
    }
    ...
    public function destroy(TourAttribute $tourAttribute)
    {
        ...
        return redirect()->route('admin.tourAttributes.index')->with('success','Tour Attribute deleted successfully');
    }
}
