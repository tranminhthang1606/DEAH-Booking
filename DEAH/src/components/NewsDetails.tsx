              ...
              <div className="col-lg-12">
                <div className="search-filter-section">
                  ...
                  <ul className="recent-news-list">
                    <li className="list">
                      <h4 className="title line-clamp-2"><a href="news-details.html"> Thế giới là một
Sách và những người làm
                    ...
                    <li className="list">
                      <h4 className="title line-clamp-2"><a href="news-details.html">Nhiệm vụ Quest:
Cuối cùng của bạn
                          [City/Region]...</a></h4>
                      <div className="d-flex justify-content-between flex-wrap gap-8">
                        <div className="d-flex align-items-center gap-8">
                    ...
                    <li className="list">
                      <h4 className="title line-clamp-2"><a href="news-details.html"> Chúng tôi du lịch, một số
              ...
              <div className="col-lg-12">
                <div className="destination-offer-three">
                  <div className="destination-content-offer">
                    ...
                    <a href="payment.html" className="btn-secondary-sm radius-30">Đặt trước Now</a>
                  </div>
                </div>
              </div>
            </div>
