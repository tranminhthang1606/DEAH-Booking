  ...
  return (
    ...
    <main>
      ...
      <section className="breadcrumbs-area breadcrumb-bg">
        <div className="container">
          <h1 className="title wow fadeInUp" data-wow-delay="0.0s">terms condition</h1>
          <div className="breadcrumb-text">
            <nav aria-label="breadcrumb" className="breadcrumb-nav wow fadeInUp" data-wow-delay="0.1s">
              <ul className="breadcrumb listing">
                <li className="breadcrumb-item single-list"><a href="index.html" className="single">Home</a></li>
                <li className="breadcrumb-item single-list" aria-current="page"><a href="javascript:void(0)" className="single active">terms condition</a></li>
              </ul>
            </nav>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-xl-12">
              ...
              <div className="single-terms mb-30">
                <h5 className="title font-600">Introduction</h5>
                <p className="pera">If you wish to purchase any product or service made available through Service (“Purchase”), you may be asked to supply certain information relevant to your Purchase including but not limited to, your credit or debit card number, the expiration date of your card, your billing address, and your shipping information. You represent and warrant that: (i) you have the legal right to use any card(s) or other payment method(s) in connection with any Purchase; and that (ii) the information you supply to us is true, correct and complete.</p>
              </div>
              {/* Single */}
              <div className="single-terms mb-30">
                <h5 className="title font-600">Communications</h5>
                <p className="pera">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Pariatur, porro!
                  Dicta voluptate
                  animi ipsum repellat reprehenderit. Error totam cum qui ab quas perferendis quod
                  commodi. Nihil
                  laudantium facere debitis quos!</p>
              </div>
              {/* Single */}
              <div className="single-terms mb-30">
                <h5 className="title font-600">Purchases</h5>
                <p className="pera mb-20">If you wish to purchase any product or service made available through
                  Service
                  (“Purchase”), you may be asked to supply certain information relevant to your Purchase
                  including but not
                  limited to, your credit or debit card number, the expiration date of your card, your
                  billing address,
                  and your shipping information. You represent and warrant that: (i) you have the legal
                  right to use any
                ...
                <p className="pera mb-20">We may employ the use of third party services for the purpose of
                  facilitating
                  payment and the completion of Purchases. By submitting your information, you grant us
                  the right to
                  provide the information to these third parties subject to our Privacy Policy.</p>
                <p className="pera mb-20">We reserve the right to refuse or cancel your order at any time for
                  reasons
                ...
                <p className="pera mb-20">We reserve the right to refuse or cancel your order if fraud or an
                  unauthorized or
                  illegal transaction is suspected.</p>
              </div>
              {/* Single */}
              <div className="single-terms mb-30">
                <h5 className="title font-600">Contests, Sweepstakes and Promotions</h5>
                <p className="pera mb-20">Any contests, sweepstakes or other promotions (collectively,
                  “Promotions”) made
                  available through Service may be governed by rules that are separate from these Terms of
                  Service. If you
                  participate in any Promotions, please review the applicable rules as well as our Privacy
                  Policy. If the
                  rules for a Promotion conflict with these Terms of Service, Promotion rules will apply.
                </p>
              </div>
              {/* Single */}
              <div className="single-terms mb-30">
                <h5 className="title font-600">Subscriptions</h5>
                <p className="pera mb-20">Some parts of Service are billed on a subscription basis
                  ("Subscription(s)"). You
                  ...
                  Subscription.</p>
                <p className="pera mb-20">At the end of each Billing Cycle, your Subscription will automatically
                  renew under
                  the exact same conditions unless you cancel it or initTheme Travello cancels it. You
                  may cancel your
                  Subscription renewal either through your online account management page or by contacting
                </p>
                <p className="pera mb-20">A valid payment method is required to process the payment for your
                  subscription. You
                  shall provide initTheme Travello with accurate and complete billing information that
                  may include but
                  not limited to full name, address, state, postal or zip code, telephone number, and a
                  valid payment
                  method information. By submitting such payment information, you automatically authorize
                  initTheme
                  Travello to charge all Subscription fees incurred through your account to any such
                  payment instruments.
                </p>
                <p className="pera mb-20">Should automatic billing fail to occur for any reason, initTheme
                  Travello reserves
                  the right to terminate your access to the Service with immediate effect.</p>
              </div>
              {/* Single */}
              <div className="single-terms mb-30">
                <h5 className="title font-600">Refunds</h5>
                <p className="pera mb-20">We issue refunds for Contracts within 30 days of the original purchase
                  of the
                  Contract.</p>
              </div>
              {/* Single */}
              <div className="single-terms mb-30">
                <h5 className="title font-600">Content</h5>
                <p className="pera mb-20">Our Service allows you to post, link, store, share and otherwise make
                  available
                ...
                <p className="pera mb-20">By posting Content on or through Service, You represent and warrant
                  that: (i)
                  ...
                  any other rights
                  of any person or entity. We reserve the right to terminate the account of anyone found
                  to be infringing
                  on a copyright.</p>
                <p className="pera mb-20">You retain any and all of your rights to any Content you submit, post
                  or display on
                  or through Service and you are responsible for protecting those rights. We take no
                  responsibility and
                  assume no liability for Content you or any third party posts on or through Service.
                  However, by posting
                  Content using Service you grant us the right and license to use, modify, publicly
                  perform, publicly
                  display, reproduce, and distribute such Content on and through Service. You agree that
                  this license
                  includes the right for us to make your Content available to other users of Service, who
                  may also use
                  your Content subject to these Terms.</p>
                <p className="pera mb-20">initThemeTravello has the right but not the obligation to monitor and
                  edit all
                  Content provided by users.</p>
                <p className="pera mb-20">In addition, Content found on or through this Service are the property
                  of initTheme
                  Travello or used with permission. You may not distribute, modify, transmit, reuse,
                  download, repost,
                  copy, or use said Content, whether in whole or in part, for commercial purposes or for
                  personal gain,
                  without express advance written permission from us.</p>
              </div>
              {/* Single */}
              <div className="single-terms mb-30">
                <h5 className="title font-600">Prohibited Uses</h5>
                <p className="pera mb-20">You may use Service only for lawful purposes and in accordance with
                  Terms. You agree
                  not to use Service:</p>
                <p className="pera mb-20">0.1. In any way that violates any applicable national or international
                  law or
                  regulation.</p>
                <p className="pera mb-20">0.2. For the purpose of exploiting, harming, or attempting to exploit
                  or harm minors
                  in any way by exposing them to inappropriate content or otherwise.</p>
                <p className="pera mb-20">0.3. To transmit, or procure the sending of, any advertising or
                  promotional
                  material, including any “junk mail”, “chain letter,” “spam,” or any other similar
                  solicitation.</p>
                <p className="pera mb-20">0.4. To impersonate or attempt to impersonate Company, a Company
                  employee, another
                  user, or any other person or entity.</p>
                <p className="pera mb-20">0.5. In any way that infringes upon the rights of others, or in any
                  way is illegal,
                  threatening, fraudulent, or harmful, or in connection with any unlawful, illegal,
                  fraudulent, or harmful
                  purpose or activity</p>
                <p className="pera mb-20">0.6. To engage in any other conduct that restricts or inhibits
                  anyone’s use or
                  enjoyment of Service, or which, as determined by us, may harm or offend Company or users
                  of Service or
                  expose them to liability.</p>
                <p className="pera mb-20">0.1. Use Service in any manner that could disable, overburden, damage,
                  or impair
                  Service or interfere with any other party’s use of Service, including their ability to
                  engage in real
                  time activities through Service.</p>
                <p className="pera mb-20">0.2. Use any robot, spider, or other automatic device, process, or
                  means to access
                  Service for any purpose, including monitoring or copying any of the material on Service.
                </p>
                <p className="pera mb-20">0.3. Use any manual process to monitor or copy any of the material on
                  Service or for
                  any other unauthorized purpose without our prior written consent.</p>
                <p className="pera mb-20">0.4. Use any device, software, or routine that interferes with the
                  proper working of
                  Service.</p>
                <p className="pera mb-20">0.5. Introduce any viruses, trojan horses, worms, logic bombs, or
                  other material
                  which is malicious or technologically harmful.</p>
                <p className="pera mb-20">0.6. Attempt to gain unauthorized access to, interfere with, damage,
                  or disrupt any
                  parts of Service, the server on which Service is stored, or any server, computer, or
                  database connected
                  to Service.</p>
                <p className="pera mb-20">0.7. Attack Service via a denial-of-service attack or a distributed
                  denial-of-service attack.</p>
                <p className="pera mb-20">0.8. Take any action that may damage or falsify Company rating.</p>
                <p className="pera mb-20">0.9. Otherwise attempt to interfere with the proper working of
                  Service.</p>
              </div>
              {/* Single */}
              <div className="single-terms mb-30">
                <h5 className="title font-600">Copyright Policy</h5>
                <p className="pera mb-20">We respect the intellectual property rights of others. It is our
                  policy to respond
                  to any claim that Content posted on Service infringes on the copyright or other
                  intellectual property
                  rights (“Infringement”) of any person or entity.</p>
                <p className="pera mb-20">If you are a copyright owner, or authorised on behalf of one, and you
                  believe that
                  the copyrighted work has been copied in a way that constitutes copyright infringement,
                  please submit
                  your claim via email to , with the subject line: “Copyright Infringement” and include in
                  your claim a
                  detailed description of the alleged Infringement as detailed below, under “DMCA Notice
                  and Procedure for
                  Copyright Infringement Claims”</p>
                <p className="pera mb-20">You may be held accountable for damages (including costs and
                  attorneys’ fees) for
