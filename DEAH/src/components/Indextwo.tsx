...
<div>
  <header className="header-area-two">
    ...
    <div className="top-header-two">
      <h4 className="title">Black Friday Discount</h4>
                  ...
                  <div className="d-flex justify-content-between align-items-center position-relative">
                    ...
                    <ul className="listing d-none d-lg-block" id="navigation">
                      <li className="single-list">
                        <a href="javascript:void(0)" className="single link-active">Home
                      ...
                      <li className="single-list">
                        ...
                        <ul className="submenu">
                          ...
                          <li className="single-list">
                            <a href="destination-details.html" className="single">Destination
                              Details</a>
                          </li>
                          <li className="single-list">
        ...
        <div className="row  g-4 align-items-center justify-content-between position-relative">
          <div className="col-xl-7 col-lg-6">
            <div className="hero-caption-two position-relative">
              <span className="highlights wow fadeInUp d-block" data-wow-delay="0.0s">Explore The Word</span>
              <h4 className="title wow fadeInUp" data-wow-delay="0.1s">  Plan Tours To Dream Locations In Just A Click! </h4>
              ...
              <div className="button-section wow fadeInUp" data-wow-delay="0.5s">
                <a href="payment.html" className="btn-secondary-sm hero-book-btn">Start Booking</a>
              </div>
            </div>
          </div>
          <div className="col-xl-5 col-lg-6">
            <div className="search-tour-card sidenav-active">
              <div className="section-title text-center">
                <h4 className="title">Search Tours</h4>
                <p className="pera"> Lorem ipsum dolor sit amet consectetur. Feugiat id sed. </p>
              </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="border-section-title">
              <h4 className="title">Why Would You Like Us</h4>
            </div>
          </div>
        </div>
        <div className="row">
                  ...
                  <div className="why-points">
                    <div className="why-point">
                      ...
                      <div className="why-content">
                        <h4 className="title line-clamp-1">Best Price Guarantee</h4>
                ...
                <div className="swiper-slide">
                  <div className="why-points">
                    <div className="why-point">
                      ...
                      <div className="why-content">
                        <h4 className="title line-clamp-1">Tour Guide</h4>
                        <p className="pera line-clamp-3">
                          A "Best Price Guarantee" is a commitment offered by
                          businesses, typically in the retail or hospitality
                        </p>
        ...
        <div className="row justify-content-center">
          <div className="col-xl-7 col-lg-7">
            <div className="section-title mx-430 mx-auto text-center">
              <span className="highlights fancy-font font-400 text-center">special offers</span>
              <h4 className="title">
        ...
        <div className="row g-4">
          <div className="col-xl-5 col-lg-5">
            <div className="section-title mx-430 mb-30">
              <span className="highlights fancy-font font-400">Tour Booking</span>
              <h4 className="title">Check Availability</h4>
              <p className="pera">
                Lorem ipsum dolor sit amet consectetur. Commodo at diam dolor
                ipsum dolor. Amet mauris amet enim dolor enim. Nisi etiam
                mauris cras velit vel commodo volutpat vestibulum. Feugiat et
                turpis congue viverra.
              </p>
            ...
            <div className="available-card">
              ...
              <div className="user-qty-card">
                ...
                <div className="count-guest">
                  <h4 className="title">
                    Guests <span className="calc-user">0</span>
                  </h4>
                </div>
                <div className="mt-30">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="destination-offer-two h-calc wow fadeInUp" data-wow-delay="0.3s">
                <div className="destination-content-offer">
                  ...
                  <h4 className="title">The Best For Less</h4>
                  <a href="payment.html" className="btn-secondary-sm">Booking Now</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row align-items-center position-relative">
          <div className="col-lg-8">
            <div className="section-title mx-526 mb-30">
              ...
              <p className="pera">
                It is a fundamental human activity that has been practiced for
                centuries and continues to be a source of joy, learning, and
                personal growth
              </p>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="discover-circle ">
              <a href="about.html" className="discover-btn">Discover More <i className="ri-arrow-right-up-line" /></a>
            </div>
          </div>
        </div>
        <div className="about-banner-two">
          <h4 className="watermark-text ">15+ years of experience</h4>
              ...
              <div className="swiper-wrapper">
                <div className="swiper-slide testimonial-card-two h-calc">
                  ...
                  <div className="testimonial-body">
                    <p className="pera">
                      Lorem ipsum dolor sit amet consectetur. Sed at libero
                      amet sed cursus. Id elementum sodales facilisis libero
                      ante egestas vitae morbi purus. Purus elementum faucibus
                      semper duis morbi fringilla quam curabitur fames.
                      Volutpat aliquet sed massa varius viverra cras non.
                      Molestie enim commodo quis viverra magna mattis varius
                      ac.
                    </p>
                  </div>
                ...
                <div className="swiper-slide testimonial-card-two h-calc">
                  ...
                  <div className="testimonial-body">
                    <p className="pera">
                      Sed at libero amet sed cursus. Id elementum sodales
                      Lorem ipsum dolor sit amet consectetur. facilisis libero
                      ante egestas vitae morbi purus. Purus elementum faucibus
                      semper duis morbi fringilla quam curabitur fames.
                      Volutpat aliquet sed massa varius viverra cras non.
                      Molestie enim commodo quis viverra magna mattis varius
                ...
                <div className="swiper-slide testimonial-card-two h-calc">
                  ...
                  <div className="testimonial-body">
                    <p className="pera">
                      Molestie enim commodo quis viverra magna mattis varius
                      ac. Lorem ipsum dolor sit amet consectetur. Sed at
                      libero amet sed cursus. Id elementum sodales facilisis
                      libero ante egestas vitae morbi purus. Purus elementum
                      faucibus semper duis morbi fringilla quam curabitur
                      fames. Volutpat aliquet sed massa varius viverra cras
                      non.
                    </p>
                  </div>
                  <div className="testimonial-footer">
