          ...
          <div className="container">
            <div className="row g-4">
              <div className="col-lg-4 col-sm-6">
                <a href="destination-details.html" className="destination-banner h-calc">
                  ...
                  <div className="destination-content">
                    ...
                    <div className="destination-info">
                      ...
                      <div className="button-section">
                        <div className="arrow-btn"><i className="ri-arrow-right-line" /></div>
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <div className="col-lg-8 col-sm-6">
                <a href="destination-details.html" className="destination-banner h-calc">
                  <img src="/src/images/destination/destination-9.png" alt="travello" />
                  <div className="destination-content">
                    <div className="ratting-badge">
                      <i className="ri-star-s-fill" />
                      <span>4.5</span>
              ...
              <div className="col-lg-5 col-sm-6">
                <a href="destination-details.html" className="destination-banner h-calc">
                  <img src="/src/images/destination/destination-2.png" alt="travello" />
                  <div className="destination-content">
                    <div className="ratting-badge">
                      <i className="ri-star-s-fill" />
                      <span>4.5</span>
