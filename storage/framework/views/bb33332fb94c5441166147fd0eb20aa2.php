                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?php echo e(route('types.index')); ?>">Types</a></li>
                                <li class="breadcrumb-item active"><a href="F<?php echo e(route('types.index')); ?>">List</a></li>
                            </ol>
                        </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($type->name_type); ?></td>
                                    <td>
                                        <button class="btn btn-sm btn-warning edit-item-btn showEdit" data-bs-toggle="modal"
                                            data-bs-target="#showModal" data-edit-value="<?php echo e($type->name_type); ?>"
                                            data-edit-id="<?php echo e($type->id); ?>">Edit</button>
                                        <form action="<?php echo e(route('types.destroy', $type->id)); ?>" method="POST"
    ...
    <script>
        $(document).ready(function() {
            $('.showEdit').click(function() {
                ...
                let form = `
                    <form class="tablelist-form" autocomplete="off" action="<?php echo e(route('type.update')); ?>" method="post" >
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATN\resources\views/admin/tour_types/index.blade.php ENDPATH**/ ?>