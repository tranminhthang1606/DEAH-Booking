<div id="scrollbar">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="<?php echo e(route('admin.index')); ?>" role="button" aria-expanded="false"
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarApps">
                    <ul class="nav nav-sm flex-column">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('tours.index')); ?>" class="nav-link" data-key="t-chat"> Quản lý Tour </a>
                        </li>

                        <li class="nav-item">
                            <a href="<?php echo e(route('attributes.index')); ?>" class="nav-link" data-key="t-chat"> Quản lý thuộc tính
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarHotels">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="<?php echo e(route('hotels.index')); ?>" class="nav-link" role="button" aria-expanded="false"
                                aria-controls="sidebarCalendar" data-key="t-calender">
                                Khách sạn hợp tác
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('services.index')); ?>" class="nav-link" data-key="t-chat"> Quản lý dịch vụ </a>
                        </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarPost">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="<?php echo e(route('posts.index')); ?>" class="nav-link" role="button" aria-expanded="false"
                                aria-controls="sidebarCalendar" data-key="t-calender">
                                Danh sách bài viết
                            </a>
                            <a href="<?php echo e(route('posts.create')); ?>" class="nav-link" role="button" aria-expanded="false"
                                aria-controls="sidebarCalendar" data-key="t-calender">
                                Thêm bài viết
                            </a>
                        </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarBooking">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="<?php echo e(route('bookings.index')); ?>" class="nav-link" role="button" aria-expanded="false"
                                aria-controls="sidebarCalendar" data-key="t-calender">
                                Danh sách đơn hàng
                            </a>
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="<?php echo e(route('users.index')); ?>" role="button" aria-expanded="false"
...
<?php /**PATH E:\Desktop\laragon\www\DEAH-Booking\resources\views/admin/layout/sidebar.blade.php ENDPATH**/ ?>