                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="F<?php echo e(route('services.index')); ?>">List</a></li>
                            </ol>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="border-0 bg-white edit-item-btn showEdit"
                                                    ...
                                                    data-edit-value="<?php echo e($service->service); ?>"
                                                    data-edit-id="<?php echo e($service->id); ?>"><i
    ...
    <script>
        $(document).ready(function() {
            $('.showEdit').click(function() {
                ...
                let form = `
                    <form class="tablelist-form" autocomplete="off" action="<?php echo e(route('services.update')); ?>" method="post" >
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Desktop\laragon\www\DEAH-Booking\resources\views/admin/services/index.blade.php ENDPATH**/ ?>