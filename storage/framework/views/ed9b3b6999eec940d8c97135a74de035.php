                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('hotels.index')); ?>">Tours</a></li>
        ...
        <form method="POST" action="<?php echo e(route('tours.store')); ?>" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <input type="text" value="<?php echo e(old('title')); ?>" name="title" id="" class="form-control"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row mt-3">
                <div class="col-4">
                    ...
                    <input type="number" value="<?php echo e(old('day')); ?>" class="form-control" name="day" id="day"
                        id="day">
                    <?php $__errorArgs = ['day'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATN\resources\views/admin/tours/create.blade.php ENDPATH**/ ?>