        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div>
                        <a href="<?php echo e(route('tours.create')); ?>" class="btn btn-primary mb-3">Thêm Tour mới</a>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Desktop\laragon\www\DEAH-Booking\resources\views/admin/tours/index.blade.php ENDPATH**/ ?>