                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; word-break: break-word;">
                                                                            <strong><span
                                                                                    style="word-break: break-word;">Cảm ơn
                                                                                    bạn đã sử dụng dịch vụ của chúng
                                                                                    tôi</span></strong>
                                                                        </p>
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; word-break: break-word;">Thông
                                                                            tin hóa đơn</p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            class="row-content stack" role="presentation"
                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF; color: #333; width: 620px; margin: 0 auto;"
                                            width="620">
                                            <tbody>
                                                <tr>
                                                    <td class="column column-1"
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; word-break: break-word;"><span
                                                                                style="word-break: break-word">
                                                                                <p>Số người:
                                                                                    <strong><?php echo e($booking->adults); ?></strong>
                                                                                    người
                                                                                    lớn,<strong>
                                                                                        <?php echo e($booking->kids6To12); ?>

                                                                                    </strong>
                                                                                    trẻ 6-12, <strong>
                                                                                        <?php echo e($booking->kids0To5); ?>
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        style="color:#000000;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:14px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
                                                                        <p style="margin: 0; word-break: break-word;"><span
                                                                                style="word-break: break-word; color: rgb(0,0,0);">
                                                                                <p>Tour: <?php echo e($booking->tour_name); ?></p>
                                                                                <p>Giá tour:
                                                                                    <?php echo e(number_format($booking->tour_price, 0, '.', '.')); ?>

                                                                                    VND</p>
                                                                                <p>Địa chỉ tour:
                                                                                    <?php echo e($booking->tour_address); ?></p>
                                                                            </span></p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; word-break: break-word;">
                                                                            <span
                                                                                style="word-break: break-word; color: rgb(0,0,0);">
                                                                                <p>Khách sạn: <?php echo e($booking->hotel_name); ?>

                                                                                </p>
                                                                                <p>Giá khách sạn:
                                                                                    <?php echo e(number_format($booking->hotel_price, 0, '.', '.')); ?>

                                                                                    VND</p>
                                                                                <p>Địa chỉ khách sạn:
                                                                                    <?php echo e($booking->hotel_address); ?>
...
<?php /**PATH E:\Desktop\laragon\www\DEAH-Booking\resources\views/mail/new-email.blade.php ENDPATH**/ ?>