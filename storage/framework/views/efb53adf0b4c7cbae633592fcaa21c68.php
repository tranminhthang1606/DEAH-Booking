                                        ...
                                        <td>
                                            <button class="btn">
                                                <i class="ri-pencil-fill showEdit fs-5 text-warning align-items-center"
                                                    ...
                                                    data-edit-value="<?php echo e($type->name_type); ?>"
                                                    data-edit-id="<?php echo e($type->id); ?>""></i>
                                            </button>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Desktop\laragon\www\DEAH-Booking\resources\views/admin/tour_types/index.blade.php ENDPATH**/ ?>