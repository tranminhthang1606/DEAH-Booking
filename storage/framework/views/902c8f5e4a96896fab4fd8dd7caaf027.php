  ...
  <script src="<?php echo e(url('assets/libs/list.pagination.js/list.pagination.min.js', [])); ?> "></script>
  <!--jquery cdn-->
  ...
  <!-- quill js -->
  <script src="<?php echo e(url('assets/libs/quill/quill.min.js', [])); ?> "></script>
  <!-- init js -->
  <script src="<?php echo e(url('assets/js/pages/form-editor.init.js', [])); ?> "></script>
  <!-- listjs init -->
  <script src="<?php echo e(url('assets/js/pages/listjs.init.js', [])); ?> "></script>
  ...
  <script src="<?php echo e(url('assets/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.js', [])); ?> ">
  </script>
  <script
      src="<?php echo e(url('assets/libs/filepond-plugin-file-validate-size/filepond-plugin-file-validate-size.min.js', [])); ?> ">
  </script>
  <script
      src="<?php echo e(url('ssets/libs/filepond-plugin-image-exif-orientation/filepond-plugin-image-exif-orientation.min.js', [])); ?> a">
  </script>
  ...
  <!-- Vector map-->
  <script src="<?php echo e(url('assets/libs/jsvectormap/js/jsvectormap.min.js', [])); ?> "></script>
  <script src="<?php echo e(url('assets/libs/jsvectormap/maps/world-merc.js', [])); ?> "></script>
  <script src="<?php echo e(url('assets/js/helper.js', [])); ?> "></script>

  <!--Swiper slider js-->
  <script src="<?php echo e(url('assets/libs/swiper/swiper-bundle.min.js', [])); ?> "></script>

  <!-- Dashboard init -->
  <script src="<?php echo e(url('assets/js/pages/dashboard-ecommerce.init.js', [])); ?> "></script>
  ...
  <script src="<?php echo e(url('assets/js/pages/select2.init.js', [])); ?> "></script>
  </body>

  </html>
<?php /**PATH E:\Desktop\laragon\www\DEAH-Booking\resources\views/admin/layout/footer.blade.php ENDPATH**/ ?>