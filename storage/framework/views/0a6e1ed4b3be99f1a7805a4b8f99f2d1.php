                            ...
                            <tbody>
                                <?php $__currentLoopData = $tourAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tourAttribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($tourAttribute->attribute_id); ?></td>
                                        <td><?php echo e($tourAttribute->tour_id); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('tourAttributes.show', $tourAttribute->id)); ?>"
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATN\resources\views/admin/tour_attribute/index.blade.php ENDPATH**/ ?>